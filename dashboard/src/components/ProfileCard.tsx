...
export function ProfileCard({ profile, onSearch }: ProfileCardProps) {
	...
	const isStale =
		typeof classification_status === "object" &&
		classification_status !== null &&
		"stale" in classification_status;
	const statusLabel =
		...
		<div class="card">
			<div class="card-header">
				...
				<div class="author-info">
					...
					<span class="pubkey" title={pubkey}>{hexToBech32("npub", pubkey) || pubkey}</span>
					{hasClassification && (
						<a
							href={`/api/chat-logs/${encodeURIComponent(pubkey)}`}
							class="chat-log-link"
							download
						>
							⬇ Chat Log
